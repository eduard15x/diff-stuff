...
// // Create Sender
// ServiceBusSender sender = client.CreateSender("firsttopic"); // you need to pass the quename

// // Send Message
// await sender.SendMessageAsync(new ServiceBusMessage("sending message to multiple subscriptions (1,2)."));

// // // Create Receiver
// // ServiceBusReceiver receiver = client.CreateReceiver("firsttopic"); // you need to pass the quename
