    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecializationYears", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SpecializationYears_Specializations_SpecializationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSpecializations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentSpecializations_Specializations_SpecializationId",
                        column: x => x.SpecializationId,
                        principalTable: "Specializations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSpecializations_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    SpecializationYearId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Modules_SpecializationYears_SpecializationYearId",
                        column: x => x.SpecializationYearId,
                        principalTable: "SpecializationYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Classes_SpecializationYears_SpecializationYearId",
                        column: x => x.SpecializationYearId,
                        principalTable: "SpecializationYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentClasses_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classes_SpecializationYearId",
                table: "Classes",
                column: "SpecializationYearId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Modules_SpecializationYearId",
                table: "Modules",
                column: "SpecializationYearId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecializationYears_SpecializationId",
                table: "SpecializationYears",
                column: "SpecializationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentClasses_ModuleId",
                table: "StudentClasses",
                column: "ModuleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentSpecializations_SpecializationId",
                table: "StudentSpecializations",
                column: "SpecializationId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSpecializations_StudentId",
                table: "StudentSpecializations",
                column: "StudentId");
        }
